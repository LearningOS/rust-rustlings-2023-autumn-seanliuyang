...
fn build_scores_table(results: String) -> HashMap<String, Team> {
    ...
    for r in results.lines() {
        ...
        // println!("before team1={}, {}", team1.goals_scored, team1.goals_conceded);

        // println!("after team1={}, {}", team1.goals_scored, team1.goals_conceded);

        // println!("team2:{}", team_2_name);
        // let team2 = scores.entry(team_2_name).or_insert(team2);
        // println!("before team2={}, {}", team2.goals_scored, team2.goals_conceded);
        // team2.goals_scored = team_2_score;
        // team2.goals_conceded = team_1_score;
        // println!("after team2={}, {}", team2.goals_scored, team2.goals_conceded);
